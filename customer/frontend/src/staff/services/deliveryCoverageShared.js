...
export function mapDeliveryAreaRecord(row) {
  ...
  return {
    ...
    coverageMode: asDeliveryText(safe.coverage_mode || safe.coverageMode) || DEFAULT_DELIVERY_AREA.coverageMode,
    centerLat: asDeliveryNumber(safe.center_lat ?? safe.centerLat, DEFAULT_DELIVERY_AREA.centerLat),
    centerLng: asDeliveryNumber(safe.center_lng ?? safe.centerLng, DEFAULT_DELIVERY_AREA.centerLng),
    maxDistanceKm: asDeliveryNumber(safe.max_distance_km ?? safe.maxDistanceKm, DEFAULT_DELIVERY_AREA.maxDistanceKm),
...
export function toCustomerDeliveryConfig(area, puroks, polygon) {
  ...
  return {
    ...
    coverageMode: normalizedArea.coverageMode,
    centerLat: normalizedArea.centerLat,
    centerLng: normalizedArea.centerLng,
    maxDistanceKm: normalizedArea.maxDistanceKm,
